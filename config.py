...
# ── Strategy ──────────────────────────────────────────────
ENTRY_ZONE_PTS      = 5.0      # Entry when price is 0-5 pts above VWAP
BUY_LIMIT_BUFFER    = 3.0      # Buy limit = ltp + 3 (guarantees fill, controls price)
VWAP_SL_BUFFER      = 2.0      # SL = live VWAP - 2 (strict, dynamic)
